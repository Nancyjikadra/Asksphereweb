...
def predict():
    ...
    try:
        ...
        video_paths = [
            'https://drive.google.com/file/d/1-kf3-mbgm6Sz2nxTlduiYCXY3-0CQk0U/view?usp=drive_link',
            'https://drive.google.com/file/d/15sd4hFYjTR6ReyXS_XG3vYL56b-2ONP9/view?usp=drive_link'
        ]
